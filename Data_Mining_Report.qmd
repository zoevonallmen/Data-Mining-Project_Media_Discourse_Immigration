...
Finally, this project draws on discourse theory to analyze how media construct boundaries between “us” (the Swiss) and “them” (immigrants). Oppositional identities are formed through language, often by assigning contrasting traits to in- and out-groups (Wodak et al., 2009, p. 33-35). In Switzerland, the SVP has played a key role in promoting exclusionary narratives (Skenderovic, 2009, p. 7-9), which could be reinforced or challenged in media discourse.
...
Skenderovic, D. (2009). The Radical Right in Switzerland: Continuity and Change, 1945–2000. Berghahn Books.
